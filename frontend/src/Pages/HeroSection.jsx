...
const HeroSection = () => {
  return (
    <div className="scrollable-section bg-app">
      {/* <!-- Hero Section --> */}
      ...
      <section className="max-w-6xl mx-auto px-4 py-16">
        {/* <!-- Heading --> */}
        <h2 className="text-5xl font-bold text-center mb-16">AI video generator</h2>
        ...
        <div className="flex flex-col md:flex-row items-center bg-gray-50 rounded-2xl overflow-hidden">
          ...
          <div className="w-full md:w-1/2 p-8 md:p-12">
            ...
            <button className="border border-blue-500 text-blue-500 py-3 px-8 rounded-full hover:bg-blue-50 transition-colors">
              Create now
            </button>
          </div>
            ...
            <div className="bg-black rounded-xl overflow-hidden relative">
              ...
              <div className="absolute top-4 left-0 right-0 mx-auto w-4/5">
                <div className="bg-gray-900 text-white p-3 rounded-lg flex items-center justify-between">
                  ...
                  <button className="bg-blue-500 text-white px-4 py-1 rounded flex items-center text-sm">
                    Generate
                    <svg
              ...
              <div className="absolute bottom-4 left-4 right-4 flex items-center">
                ...
                <span className="text-white text-xs ml-2">01:05 / 02:00</span>
              </div>
            </div>
          </div>
        </div>
